class ParameterSetting():
    def __init__(self, csv_path='./', data_dir='furbo_only', aug_dir='samoya_only', np_dir='Woof', save_root='snapshots', model_file='snapshots/final_model.pkl', 
                 ...
                 sr=8000, nfft=200, hop=80, mel=64, p=0, alpha=0, resume=None, normalize=None, preload=False,
